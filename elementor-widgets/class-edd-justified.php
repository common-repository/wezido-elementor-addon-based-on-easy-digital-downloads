 ...
 * @since 1.0.0
 */
class Wezido_edd_justified extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Edd Justified', 'wezido' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'section_content',
            [
                'label' => __( 'Wezido EDD Justified Grid', 'wezido' ),
            ]
        );
  ...
  $this->add_control(
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .wezido-edd-item,{{WRAPPER}} .wezido-edd-thumbnail,{{WRAPPER}} .wezido-edd-thumbnail img,{{WRAPPER}} .wez-product-justified-description' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			$this->add_group_control(
                ...
                array(
                    ...
                    'selector'  => '{{WRAPPER}} .wez-product-justified-description h5 a',
                )
            );  
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wez-product-justified-description h5 a' => 'color: {{VALUE}}',
				],
			]
		);
    ...
    protected function render() {
        ...
        <div class="wezido-edd-justified gridzy flex flex-wrap overflow-hidden sm:-mx-2 lg:-mx-2 xl:-mx-2" data-gridzy-layout="justified" data-gridzy-spaceBetween="<?php echo esc_html($image_gap);?>">
            <?php
    ...
    $max_num_pages = $the_query->max_num_pages;?>
        ...
        <div class="wezido-edd-justified-item relative">
            <div class="wezido-edd-thumbnail">
                ...
                <div class="wez-product-justified-description">
